...
<body>
	                        ...
	                        <tbody id="cart-container">
	                           <c:forEach var="cartItem" items="${cart.cartItems}">
	                                <tr class="data-table" id="${cartItem.productId }">
	                                    <td scope="col"><input type="checkbox" onclick="changeStatus(${cartItem.productId})"></td>
	                                    <td>
	                                        <div class="media">
	                                            <div class="d-flex">
	                                    ...
	                                    <td>
	                                        <h5 id="price">
	                                            ...
	                                            <fmt:formatNumber value="${cartItem.priceUnit}" minFractionDigits="0" type="currency" currencySymbol="&#8363;"/>
	                                        </h5>
	                                    </td>
	                                    <td>
	                                        <div class="d-flex flex-row">
	                                            <div class="up-down decrease" onclick="alterProductOrder('decrease',${cartItem.maxOrder},${cartItem.productId})">
	                                                <i class="fas fa-minus"></i>
	                                            </div>
	                                            <div class="number_product_order">
	                                                <input class="text-center" id="number_order" onkeypress="return isNumberKey(event)"
	                                                onfocusout="focusOut(${cartItem.productId})" onfocus="getOldValue(${cartItem.productId})" 
	                                                onkeyup="checkValid(${cartItem.maxOrder},${cartItem.productId})" 
	                                                onchange="totalMoney(${cartItem.productId})" type="text" value="${cartItem.quanlity}">
	                                            </div>
	                                            <div class="up-down increment" onclick="alterProductOrder('increment', ${cartItem.maxOrder},${cartItem.productId})">
	                                    ...
	                                    <td onclick="deleteRecord(${cartItem.productId})"><i class="fas fa-trash-alt"></i></td>
	                                </tr>
	                        	</c:forEach>
	                            <tr>
	                                <td></td>
    ...
    function showAlertMessage(message, messageState) {
        if (messageState) {
            $('#alert_message').css({ "background-color": "#C5F3D7", "border-left": "8px solid #2BD971" });
            ...
            $('#alert_message').css({ "background-color": "#FFE1E3", "border-left": "8px solid #FF4456" });
    ...
    function loadTotalMustPay() {
        ...
        if ($('#cart-container>tr').length <= 1) {
            ...
            html += '<img src="${base}/user/myImages/shopping_cart.png" alt="Chưa có sản phẩm nào trong giỏ!" style="width:200px;height:auto" />';
