...
<head>
    ...
    <!-- Title Page-->
    <title>Blog | Admin Electronic Device</title>
                                            ...
                                            <div class="col-md-12">
                                                <form enctype="multipart/form-data" id="form--upload">
													...
													<div class="form-group">
                                                        <label for="category">Danh mục blog<span class="required_field">*</span></label>
                                                        <select class="form-control " id="select-category" name="id_category_blog">
                                                            
                                                        </select>
                                                    </div>
													
                                                   <div class="form-group">
                                                        <label for="name">Tên blog <span class="required_field">*</span></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="description">Mô tả <span class="required_field">*</span></label>
                                                        <input autocomplete="off" name="description" class="form-control" placeholder="Mô tả" id="description" required="required"/>
                                                    </div>
    ...
    function loadDetailForEdit(idBlog) {
    	$.ajax({
    		...
    		success: function(result) {
    			$('#id').val(result.blog[0].id);
    			$('#name').val(result.blog[0].name);
    			$('#select-category').val(result.blog[0].id_category);
    			$('.img--avatar').css("background-image", "url(/upload/" + result.blog[0].avatar + ")");
    			$('#seo').val(result.blog[0].seo);
    			$('#description').val(result.blog[0].description);
    			if (result.blog[0].status == true) {
    				$('#status1').attr("checked", true);
    			} else {
    				$('#status2').attr("checked", true);
    			}
    			if (result.blog[0].isHot == true) {
    				$('#isHot1').attr("checked", true);
    			} else {
    				$('#isHot2').attr("checked", true);
    			}
    			editor.setData(result.blog[0].detail);
    		},
