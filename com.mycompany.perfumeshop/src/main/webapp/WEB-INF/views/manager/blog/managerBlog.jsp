                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                    	<c:if test="${blogRole.insert ==true}">	
	                                       <button class="au-btn au-btn-icon au-btn--green au-btn--small" onclick="location.href='${base}/admin/add-blog'">
	                                           <i class="fas fa-plus"></i>Thêm mới</button>
	                                  	</c:if>
	                                  	<input id="update_role" value="${blogRole.update}" type="text" style="display: none"/> 
                                    	<input id="delete_role" value="${blogRole.delete}" type="text" style="display: none"/>
                                    </div>
                                </div>
    ...
    <jsp:include page="/WEB-INF/views/manager/layout/script.jsp"></jsp:include>
     ...
     function setActiveMenu() {
    	...
    	function loadBlog(keySearch,currentPage) {
    		...
    		$.ajax({
    			...
    			success: function(result) {
    				var html = '';
    				$.each(result.blogs, function(index, value) {
    	...
    	function deleteCategory(idBlog) {
            $('#btn_save').attr("onclick", "deleteConfirmed(" + idBlog +")");
            $('#modalConfirmOderContent').text("Bạn chắc chắn muốn xóa blog này ?");
            $('#btn_save').show();
            $('#btn_save').text("Có");
