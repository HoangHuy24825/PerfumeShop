...
<body class="">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <div class="d-flex">
                                    <a href="${base}/admin/product/index" class="btn_back_list"><i class="fa fa-arrow-left"></i></a> &nbsp
                                            ...
                                            <div class="col-md-12">
                                                <form id="form--upload" enctype="multipart/form-data" >
                                                    ...
                                                    <div class="form-group">
                                                        <label for="category">Danh mục <span class="required_field">*</span></label>
                                                   ...
                                                   <div class="form-group">
                                                        <label for="title">Tên sản phẩm <span class="required_field">*</span></label>
                                                        <input autocomplete="off" type="text" class="form-control" id="title" name="title" placeholder="Tên sản phẩm" required="required" ></input>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="price">Giá <span class="required_field">*</span></label>
                                                        <input type="number" autocomplete="off" class="form-control" id="price" name="price" placeholder="Giá sản phẩm" required="required"></input>
                                                    </div>
                                                    
                                                    <div class="form-group">
                                                        <label for="priceSale">Giảm giá </label>
                                                        <input type="number" autocomplete="off" class="form-control" id="priceSale" name="priceSale" placeholder="Giảm giá"></input>
                                                    </div>
                                                   ...
                                                   <!--   <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off" class="form-control" id="model" name="model" placeholder="model"></input>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="origin">Xuất xứ </label>
                                                        <input type="text" autocomplete="off" class="form-control" id="origin" name="origin" placeholder="Xuất xứ"></input>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="amount">Số lượng </label>
                                                        <input type="number" autocomplete="off" class="form-control" id="amount" name="amount" placeholder="Số lượng"></input>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="guarantee">Bảo hành (tháng) </label>
                                                        <input type="number" autocomplete="off" class="form-control" id="guarantee" name="guarantee" placeholder="Bảo hành"></input>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="short_description">Mô tả ngắn <span class="required_field">*</span></label>
                                                        <textarea autocomplete="off" class="form-control" placeholder="Short Description" id="description" name="description" rows="8" required="required"></textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row mt-4">
                                                            <div class="col-sm-2 imgUp">
                                                                <div class="imagePreview image--product" data-id-image=""></div>
                                                            <label class="btn btn-primary btn--upload-image">Upload
                                                                <input type="file" class="uploadFile img uploadImages" name="images" accept="image/png, image/jpeg, image/jpg"  style="width: 0px;height: 0px;overflow: hidden;">
                                                            </label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="detail">Chi tiết <span class="required_field">*</span></label>
                                                    ...
                                                    <div class="form-group">
                                                        <a class="btn btn-secondary" href="${base}/admin/product/index">Hủy</a>
	...
	$(document).ready(function() {
		editor = CKEDITOR.replace('detail',{width: ['100%'], height: ['400px']});
