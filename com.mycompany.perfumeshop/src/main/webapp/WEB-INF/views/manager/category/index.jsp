    		...
    		$.ajax({
    			...
    			success: function(result) {
    				...
    				$.each(result.categories, function(index, value) {
    					...
    					html += '           <button class="item view_category" title="Xem" onclick="detail(' + value.id + ')">';
    					html += '                <input type="hidden" id="view_'+value.id+'" name="custId" value="'+value.seo+'">';
    					html += '               <i class="fas fa-eye"></i>';
    					html += '           </button>';
    					if (update_role=='true') {
    						html += '          <button class="item update_category" title="Sửa">';
    					...
    					if (delete_role=='true') {
    						html += '           <button class="item delete_category" title="Xóa" onclick="deleteCategory(' + value.id + ')">';
