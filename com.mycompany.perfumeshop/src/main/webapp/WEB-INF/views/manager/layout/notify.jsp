...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>  
 ...
 <!--START MODAL DETAIL -->
	<div class="modal fade" id="notify-modal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
	...
	<!--END MODAL DETAIL -->
	 ...
	 <!--START MODAL DETAIL -->
	<div class="modal fade" id="notify-detail-modal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="mediumModalLabel">
	                    Đơn hàng mã: <span id="code-order-notify"></span> - <span id="status-orders-notify"> Chưa xác nhận </span><br/> ID: <span id="id-order-notify"></span>
	                </h5>
	                <br/>
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    <span aria-hidden="true">&times;</span>
	                ...
	                <div id="order--information">
	                    <div class="p-4">
			                ...
			                <ul class="text-muted"  id="status--order">
			                 	<li style="list-style-type:none" id="status--4--notify" class="d-none text-danger"><i class="fas fa-hand-point-right"></i> Đơn hàng đã bị hủy</li>
				                <li style="list-style-type:none" id="status--3--notify"><i class="fas fa-hand-point-right"></i> Giao hàng thành công</li>
				                <li style="list-style-type:none" id="status--2--notify"><i class="fas fa-hand-point-right"></i> Đang giao hàng</li>
				                <li style="list-style-type:none" id="status--1--notify"><i class="fas fa-hand-point-right"></i> Đã tiếp nhận đơn hàng</li>
				                <li style="list-style-type:none" id="status--0--notify"><i class="fas fa-hand-point-right"></i> Chưa tiếp nhận đơn hàng</li>
			                </ul>
			                <hr/>
	                    </div>
	...
	<!--::START MODAL CONFIRM::-->
   	 <div class="modal fade" id="modal-reason-reject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	      ...
	      <div class="modal-body">
	        <form>
	          <div class="form-group">
	            ...
	            <textarea class="form-control" id="input-reason-reject" name="input-reason-reject" rows="3"></textarea>
