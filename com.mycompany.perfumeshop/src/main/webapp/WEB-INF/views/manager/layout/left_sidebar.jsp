...
<aside class="menu-sidebar d-none d-lg-block">
	<div class="logo">
		<a href="${base}/manager/dashboard"> <img
			src="${base}/manager/images/logo_admin.png" alt="Admin" />
		</a>
	</div>
		...
		<nav class="navbar-sidebar">
			<ul class="list-unstyled navbar__list">
				...
				<c:if test="${productRole.view==true}">
					<li id="menu--product" class=""><a href="${base}/admin/product">
							<i class="fas fa-sitemap"></i>Sản Phẩm
					</a></li>
				</c:if>
				
				<c:if test="${orderRole.view==true}">
					<li id="menu--order" class=""><a href="${base}/admin/order">
							<i class="fas fa-money-check"></i>Đơn hàng
					</a></li>
				</c:if>
				
				<c:if test="${categoryBlogRole.view==true}">
				<li id="menu--category--blog" class=""><a href="${base}/admin/category-blog">
						<i class="fas fa-th-list"></i>Danh mục blog
				</a></li>
				</c:if>
				
				<c:if test="${blogRole.view==true}">
				<li id="menu--blog" class=""><a href="${base}/admin/blog">
						<i class="fab fa-blogger"></i>Blog
				</a></li>
				</c:if>
				
				<c:if test="${accountRole.view==true}">
				<li id="menu--account" class=""><a href="${base}/admin/account">
						<i class="fas fa-user-circle"></i>Tài Khoản
				</a></li>
				</c:if>
				
				<c:if test="${introduceRole.view==true}">
				<li id="menu--introduce" class=""><a href="${base}/admin/introduce">
