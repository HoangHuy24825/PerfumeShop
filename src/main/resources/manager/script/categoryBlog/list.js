$(document).ready(function () {
    ...
    $("body").on("change", ".btnChangeStatus", function (e) {
        ...
        $.post({
            url: "/perfume-shop/admin/change-detail-category-blog",
            data: {
                status: status,
                id: id
            },
...
function detail(id) {
    window.location.href = '/perfume-shop/admin/category-blog-detail/' + $('#view_' + id).val();
}

function edit(id) {
    window.location.href = '/perfume-shop/admin/edit-category-blog/' + $('#edit_' + id).val();
}
